...
Capítulo~\ref{cap:desarrollo_metodologia} y los resultados del Capítulo~\ref{ch:resultados}. El grado
...
Operator Ansatz}, y su aplicación específica a mezcladores $XY$ inicializados en estados
